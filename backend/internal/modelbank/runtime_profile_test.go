...
func TestRuntimeProfileExposesVendorSpecificThinkingControls(t *testing.T) {
	cases := []struct {
		...
		{name: "glm 5.3 flash", provider: "zhipu", modelID: "glm-5.3-flash", family: "glm", format: ThinkingFormatGLMThinking, optionCount: 3, defaultEffort: "high"},
		...
		{name: "minimax m2 highspeed", provider: "minimax", modelID: "MiniMax-M2.7-highspeed", family: "minimax", format: ThinkingFormatMiniMaxThinking, optionCount: 0, defaultEffort: ""},

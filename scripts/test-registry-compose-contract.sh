...
grep -Fq 'image: ${DOCKERHUB_NAMESPACE:-gjhuo}/effchat-backend:${EFFCHAT_VERSION:-v0.3.4-beta.3}' "$COMPOSE_FILE"
grep -Fq 'image: ${DOCKERHUB_NAMESPACE:-gjhuo}/effchat-web:${EFFCHAT_VERSION:-v0.3.4-beta.3}' "$COMPOSE_FILE"
grep -Fq 'image: ${DOCKERHUB_NAMESPACE:-gjhuo}/effchat-py-extractor:${EFFCHAT_VERSION:-v0.3.4-beta.3}' "$COMPOSE_FILE"
